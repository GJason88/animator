...
/**
 * Interface to represent an AnimationBuilder which is used in file reading to construct
 * a new ShapeAnimation based off of a file or when an implementation of this AnimationBuilder
 * is called.
 *
 * @param <Doc> The file that we are reading from
 */
